  ...
  return (
    <section className="w-full h-full">
      ...
      >
        ...
        <InvestVideo />
        <InvestBalance />
        {/* <div className="fixed w-[119px] h-[119px] bg-[#A4A4A4] blur-[64.7px] max-xsmall:top-[270px] max-small:top-[310px] top-[410px] left-[-20px] rounded-[50%] z-10"></div>
        <div className="fixed w-[142px] h-[142px] bg-[#A4A4A4] blur-[64.7px] max-xsmall:top-[200px] top-[240px] right-[-48px] rounded-[50%] z-10"></div> */}
        <div className="fixed w-[119px] h-[119px] max-xsmall:w-[79px] max-xsmall:h-[79px] bg-[#A4A4A4] blur-[64.7px] max-xsmall:top-[310px] top-[410px] left-[-20px] rounded-[50%] z-10"></div>
